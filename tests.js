...
test('getPosition', t => {
  ...
  element = new Node({ top: 37, left: 79, width: 40, height: 25 }, doc);
  t.is(getPosition(element, container, 3, 3), 'top left', 'top left');

  element = new Node({ top: 37, left: 80, width: 40, height: 25 }, doc);
  t.is(getPosition(element, container, 3, 3), 'top center', 'top center');

  element = new Node({ top: 37, left: 181, width: 40, height: 25 }, doc);
  t.is(getPosition(element, container, 3, 3), 'top right', 'top right');

  element = new Node({ top: 38, left: 79, width: 40, height: 25 }, doc);
  t.is(getPosition(element, container, 3, 3), 'middle left');

  element = new Node({ top: 38, left: 80, width: 40, height: 25 }, doc);
  t.is(getPosition(element, container, 3, 3), 'middle center', 'middle center');

  element = new Node({ top: 38, left: 181, width: 40, height: 25 }, doc);
  t.is(getPosition(element, container, 3, 3), 'middle right', 'middle right');

  element = new Node({ top: 88, left: 79, width: 40, height: 25 }, doc);
  t.is(getPosition(element, container, 3, 3), 'bottom left', 'bottom left');

  element = new Node({ top: 88, left: 80, width: 40, height: 25 }, doc);
  t.is(getPosition(element, container, 3, 3), 'bottom center', 'bottom center');

  element = new Node({ top: 88, left: 181, width: 40, height: 25 }, doc);
  t.is(getPosition(element, container, 3, 3), 'bottom right', 'bottom right');
});

test('getCoords', t => {
  const doc = new Document({ top: -5, left: -10 });
  const reference = new Node({ top: 25, left: 30, width: 20, height: 10 }, doc);
  const element = new Node({ width: 40, height: 30 }, doc);
...
test('getCoords with boundary container', t => {
  const doc = new Document({ top: -5, left: -10 });
  const container = new Window({ innerWidth: 100, innerHeight: 70 });
  const element = new Node({ width: 40, height: 30 }, doc);

  let reference;

  reference = new Node({ top: 29, left: 0, width: 20, height: 10 }, doc);
  ...
  reference = new Node({ top: 30, left: 61, width: 20, height: 10 }, doc);
  t.deepEqual(
    getCoords('top left', element, reference, container),
  ...
  reference = new Node({ top: 29, left: 61, width: 20, height: 10 }, doc);
  t.deepEqual(
    getCoords('top left', element, reference, container),
  ...
  reference = new Node({ top: 29, left: 10, width: 20, height: 10 }, doc);
  t.deepEqual(
  ...
  reference = new Node({ top: 30, left: 9, width: 20, height: 10 }, doc);
  t.deepEqual(
    getCoords('top center', element, reference, container),
  ...
  reference = new Node({ top: 30, left: 71, width: 20, height: 10 }, doc);
  t.deepEqual(
    getCoords('top center', element, reference, container),
  ...
  reference = new Node({ top: 29, left: 9, width: 20, height: 10 }, doc);
  t.deepEqual(
    getCoords('top center', element, reference, container),
  ...
  reference = new Node({ top: 24, left: 61, width: 20, height: 10 }, doc);
  t.deepEqual(
    getCoords('top center', element, reference, container),
  ...
  reference = new Node({ top: 29, left: 20, width: 20, height: 10 }, doc);
  t.deepEqual(
  ...
  reference = new Node({ top: 30, left: 19, width: 20, height: 10 }, doc);
  t.deepEqual(
    getCoords('top right', element, reference, container),
  ...
  reference = new Node({ top: 29, left: 19, width: 20, height: 10 }, doc);
  t.deepEqual(
    getCoords('top right', element, reference, container),
  ...
  reference = new Node({ top: 0, left: 41, width: 20, height: 10 }, doc);
  t.deepEqual(
  ...
  reference = new Node({ top: 41, left: 40, width: 20, height: 10 }, doc);
  t.deepEqual(
    getCoords('right top', element, reference, container),
  ...
  reference = new Node({ top: 41, left: 41, width: 20, height: 10 }, doc);
  t.deepEqual(
    getCoords('right top', element, reference, container),
  ...
  reference = new Node({ top: 10, left: 41, width: 20, height: 10 }, doc);
  t.deepEqual(
  ...
  reference = new Node({ top: 9, left: 41, width: 20, height: 10 }, doc);
  t.deepEqual(
    getCoords('right middle', element, reference, container),
  ...
  reference = new Node({ top: 51, left: 41, width: 20, height: 10 }, doc);
  t.deepEqual(
    getCoords('right middle', element, reference, container),
  ...
  reference = new Node({ top: 20, left: 41, width: 20, height: 10 }, doc);
  t.deepEqual(
  ...
  reference = new Node({ top: 19, left: 40, width: 20, height: 10 }, doc);
  t.deepEqual(
    getCoords('right bottom', element, reference, container),
  ...
  reference = new Node({ top: 19, left: 41, width: 20, height: 10 }, doc);
  t.deepEqual(
    getCoords('right bottom', element, reference, container),
  ...
  reference = new Node({ top: 31, left: 0, width: 20, height: 10 }, doc);
  t.deepEqual(
  ...
  reference = new Node({ top: 31, left: 61, width: 20, height: 10 }, doc);
  t.deepEqual(
    getCoords('bottom left', element, reference, container),
  ...
  reference = new Node({ top: 31, left: 10, width: 20, height: 10 }, doc);
  t.deepEqual(
  ...
  reference = new Node({ top: 31, left: 9, width: 20, height: 10 }, doc);
  t.deepEqual(
    getCoords('bottom center', element, reference, container),
  ...
  reference = new Node({ top: 31, left: 71, width: 20, height: 10 }, doc);
  t.deepEqual(
    getCoords('bottom center', element, reference, container),
  ...
  reference = new Node({ top: 0, left: 39, width: 20, height: 10 }, doc);
  t.deepEqual(
  ...
  reference = new Node({ top: 41, left: 39, width: 20, height: 10 }, doc);
  t.deepEqual(
    getCoords('left top', element, reference, container),
  ...
  reference = new Node({ top: 10, left: 39, width: 20, height: 10 }, doc);
  t.deepEqual(
  ...
  reference = new Node({ top: 9, left: 39, width: 20, height: 10 }, doc);
  t.deepEqual(
    getCoords('left middle', element, reference, container),
  ...
  reference = new Node({ top: 51, left: 39, width: 20, height: 10 }, doc);
  t.deepEqual(
    getCoords('left middle', element, reference, container),
  ...
  reference = new Node({ top: 20, left: 39, width: 20, height: 10 }, doc);
  t.deepEqual(
  ...
  reference = new Node({ top: 19, left: 39, width: 20, height: 10 }, doc);
  t.deepEqual(
    getCoords('left bottom', element, reference, container),
